...
module tb_task5_p3;
    ...
    initial begin
        $dumpfile("/content/project/waveforms/task5_p3.vcd");
        $dumpvars(0, tb_task5_p3);
        ...
        token_id = 8'd10; #100;
        $display("[P3T1] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd20; #100;
        $display("[P3T2] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd30; #100;
        $display("[P3T3] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd40; #100;
        $display("[P3T4] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd50; #100;
        $display("[P3T5] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd60; #100;
        $display("[P3T6] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd70; #100;
        $display("[P3T7] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd80; #100;
        $display("[P3T8] tok=%0d out=%0d", token_id, x_out);

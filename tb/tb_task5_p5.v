...
module tb_task5_p5;
    ...
    initial begin
        $dumpfile("/content/project/waveforms/task5_p5.vcd");
        $dumpvars(0, tb_task5_p5);
        ...
        token_id = 8'd255; #100;
        $display("[P5T1] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd128; #100;
        $display("[P5T2] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd64; #100;
        $display("[P5T3] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd32; #100;
        $display("[P5T4] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd16; #100;
        $display("[P5T5] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd8; #100;
        $display("[P5T6] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd4; #100;
        $display("[P5T7] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd2; #100;
        $display("[P5T8] tok=%0d out=%0d", token_id, x_out);

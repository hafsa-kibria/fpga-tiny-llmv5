...
module tb_task5_p1;
    ...
    initial begin
        $dumpfile("/content/project/waveforms/task5_p1.vcd");
        $dumpvars(0, tb_task5_p1);
        ...
        token_id = 8'd1; #100;
        $display("[P1T1] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd2; #100;
        $display("[P1T2] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd3; #100;
        $display("[P1T3] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd4; #100;
        $display("[P1T4] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd5; #100;
        $display("[P1T5] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd6; #100;
        $display("[P1T6] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd7; #100;
        $display("[P1T7] tok=%0d out=%0d", token_id, x_out);
        token_id = 8'd8; #100;
        $display("[P1T8] tok=%0d out=%0d", token_id, x_out);
